...
import static com.dex.fridge.FridgeDex.MENU_LAYER;
import static com.dex.fridge.FridgeDex.MAIN_VIEW;
import static com.dex.fridge.FridgeDex.RECIPE_VIEW;
...
public class DrawerManager {
    ...
    public DrawerManager() {
        ...
        final Item recipeItem = new ViewItem("Recipe", MaterialDesignIcon.DASHBOARD.graphic(), RECIPE_VIEW);
        drawer.getItems().addAll(mainItem, recipeItem);
